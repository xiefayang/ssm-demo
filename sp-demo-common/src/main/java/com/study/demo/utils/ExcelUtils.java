...
public class ExcelUtils {
     ...
     * @throws Exception
     */
    public static <T> List<T> readExcelToEntity(Class<T> classzz, InputStream in, String fileName, List<ExcelHeadMapper> excelHeads) throws Exception {
     ...
     * @throws Exception
     */
    private static <T> List<T> readExcel(Class<T> classzz, Workbook workbook, List<ExcelHeadMapper> excelHeads) throws Exception {
        ...
        for (int sheetIndex = 0; sheetIndex < sheetNum; sheetIndex++) {
            ...
            for (int rowIndex = firstRowNum + 1; rowIndex <= lastRowNum; rowIndex++) {
                ...
                if (dataRow == null)
                    continue;
                /**
                 * 无excelHeads，默认不校验非空字段，忽略空列，提高效率
                 */
                ...
                for (int cellIndex = firstCellNum; cellIndex < lastCellNum; cellIndex++) {
                    ...
                    ExcelHeadMapper eHead = null;
                    if (!CollectionUtils.isEmpty(excelHeads)) {
                        for (ExcelHeadMapper excelHead : excelHeads) {
     ...
     * @throws Exception
     */
    private static void volidateValueRequired(ExcelHeadMapper excelHead, String sheetName, int rowIndex) throws Exception {
        if (excelHead != null && excelHead.isRequired()) {
            System.out.println("《" + sheetName + "》第" + (rowIndex + 1) + "行:\"" + excelHead.getExcelName() + "\"不能为空！");
            throw new Exception();
        }
    }
